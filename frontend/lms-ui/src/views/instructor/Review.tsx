                                                    ...
                                                    <div className="mt-2">
                                                        ...
                                                        <div className="collapse" id="collapseExample">
                                                            <div className="card card-body">
                                                                <form>
                                                                    <div className="mb-3">
                                                                        <label htmlFor="exampleInputEmail1" className="form-label">Write Response</label>
                                                                        <textarea name="" id="" cols={30} className='form-control' rows={4}></textarea>
                                                                    </div>

                                                                    <button type="submit" className="btn btn-primary">Send Response <i className='fas fa-paper-plane'> </i></button>
                                                                </form>
                                                            </div>
                                                        </div>
