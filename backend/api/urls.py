...
urlpatterns = [
    ...
    path('user/change-password/',
         api_views.ChangePasswordAPIView.as_view(), name='change_password'),
    ...
    path('course/cart-list/<cart_id>/',
         api_views.CartListAPIView.as_view(), name='cart_list'),
    path('course/cart-item-delete/<cart_id>/<item_id>/',
         api_views.CartItemDeleteAPIView.as_view(), name='cart_item_delete'),
    path('cart/cart-stats/<cart_id>/',
         api_views.CartStatsAPIView.as_view(), name='cart_stats'),
    path('order/create-order/',
         api_views.CreateOrderAPIView.as_view(), name='create_order'),
    path('order/checkout/<oid>/',
         api_views.CheckoutAPIView.as_view(), name='checkout'),
    ...
    path('payment/payment-success/',
         api_views.PaymentSuccessAPIView.as_view(), name='payment_success'),
    ...
    path('student/course-list/<user_id>/',
         api_views.StudentCourseListAPIView.as_view(), name='student_course_list'),
