...
class Teacher(models.Model):
    ...
    image =models.FileField(upload_to='course-file', blank=True, default='default.jpg')
...
class Course(models.Model):
    ...
    language=models.CharField(choices=LANGUAGE,default='Eng') 
    level = models.CharField(choices=LANGUAGE, default='Beginner')
    platform_status = models.CharField(choices=PLATFORM_STATUS, default='Published')
    teacher_status = models.CharField(choices=TEACHER_STATUS, default='Published')
